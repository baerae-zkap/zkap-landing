  ...
  return (
    <div ref={containerRef} style={{ height: "280vh" }}>
      <div className="sticky top-0 overflow-hidden" style={{ height: "100dvh" }}>
        ...
        <div
          className="absolute inset-0 z-20 flex items-center md:items-center justify-start md:justify-between gap-6 md:gap-0 px-5 md:px-6 pointer-events-none flex-col md:flex-row pt-20 md:pt-0 max-w-[1100px] mx-auto"
